...
float wrap180(float a) { //normalize from -180 to 180
...
namespace Pheripherials {
    ...
    void inputs_update() {
        ...
        if((ST::now_ms - times[3] >= 100 && (IN::motionSens.hasBall || ST::soccer.role == ST::Types::role_t::Defender) ) || ST::now_ms - times[3] >= 1000) {
            input_pixy_update();
            times[3] = ST::now_ms;
            }
        ...
        if(ST::state.mode != ST::Types::mode_t::Soccer && ST::state.mode != ST::Types::mode_t::Controller) {
